...
[![Docker Pulls](https://img.shields.io/docker/pulls/wanghkkk/whoami.svg)](https://hub.docker.com/r/wanghkkk/whoami/)
...
| `version` | WHOAMI_VERSION       | print this server version for updating  |
...
```console
docker run -d -P -v ./certs:/certs --name iamfoo wanghkkk/whoami:v1 --cert /certs/example.cert --key /certs/example.key
```
